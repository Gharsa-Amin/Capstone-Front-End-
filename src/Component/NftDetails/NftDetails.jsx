...
export default function NftDetails() {
	...
	// Helper function to determine the color based on the value (green for positive, red for negative)
	const getColor = (value) => {
		if (value > 0) return "green"; // Positive gain
		if (value < 0) return "red"; // Negative loss
		return "gray"; // Neutral or undefined
	};

	// Percentage change data object
